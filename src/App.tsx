...
function App() {
  ...
  if (status === "error") {
    return (
      <div className="flex min-h-screen items-center justify-center p-8">
        <div className="animate-in fade-in slide-in-from-bottom-2 w-full max-w-md space-y-4 duration-400">
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-8">
      <div className="animate-in fade-in slide-in-from-bottom-2 w-full max-w-lg duration-400">
